...
import { TIPOPAGOURL } from '@/modules/Seguridad/components/Reuse/ConstObj';
...
export default function PagosGeneral() {
  ...
  const URLALUMNOS = `http://127.0.0.1:8000/datos_alumno/api/alumno/${id}/`;
  ...
  useEffect(() => {
    const fetchUsuarios = async () => {
      try {
        ...
        const TipoPago = await axios.get(
          `${CONFIGURACION_API}=TIPO_PAGO`,
          headers
        );
