...
const InscribirAlumno = () => {
  ...
  // if(false) {
  //   //cambiar el push por uno que indique el lugar del step de familiar extra
  //   const newPaginado = [...paginado].push({
  //     title: "Datos del familiar extra",
  //     content: <DatosFamiliarExtra control={form.control} />,
  //   });
  //   setPaginado(newPaginado);
  // }
  ...
  const onSubmit = async () => {
    try {
      ...
      const newPromise = [...promises].push(
        axios.post(
      ...
      setPromises(newPromise);

      console.log("Datos del estudiante:", estudianteData);
      console.log("Datos del padre (sin sufijo):", padreData);
      console.log("Datos del madre (sin sufijo):", madreData);
      console.log("Datos del familiar extra (sin sufijo):", familiarExtraData);

      console.log("Mama apoderado", apoderadoMadre);
      console.log("Papa apoderado", apoderadoPadre);
      ...
      // message.success("Formulario enviado exitosamente");
      // setCurrent(0);
      // setFormDataEstudiante(DEFAULT_VALUES_DATOS_ESTUDIANTE);
