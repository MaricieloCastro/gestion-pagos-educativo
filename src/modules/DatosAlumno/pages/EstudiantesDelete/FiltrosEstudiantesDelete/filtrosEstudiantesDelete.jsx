...
import './FiltrosEstudiantesDelete.scss';

import PropTypes from 'prop-types';

const FiltrosEstudiantesDelete = ({ classNameFiltros, setParams }) => {
...
export default FiltrosEstudiantesDelete;

FiltrosEstudiantesDelete.propTypes = {
