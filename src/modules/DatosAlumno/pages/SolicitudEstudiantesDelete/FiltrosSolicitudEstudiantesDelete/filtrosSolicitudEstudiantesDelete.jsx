...
export const filtrosSolicitudEstudiantesDelete = (
    setFilteringTipo,
    setFilteringSearch,
    filteringSearch
) => {
    return (
        <>
            <div className="filtros-solicitud-estudiantes-delete__search">
                <div className="filtros-solicitud-estudiantes-delete__search-elements gap-4 items-center px-4">
                    <SelectFiltros
                        title="TURNO"
