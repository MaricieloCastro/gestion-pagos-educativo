...
const AlumnosBeneficiados = () => {
    ...
    return (
        <MenuLateral>
            <Reporte loadingApiPDF={loading} apiFiltros={beneficioAPI} tittleFiltro="Beneficio:" apiReporte={data} nombreReporte="Beneficios" optionSelected={optionSelected} setOptionSelected={setOptionSelected} triggerReporte={triggerReporte} setTriggerReporte={setTriggerReporte} >
