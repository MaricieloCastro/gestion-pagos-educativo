            ...
            data.map((itemGroup, groupIndex) => (
                <View wrap style={styles.cuerpo} key={groupIndex}>
                    <View wrap={false} style={styles.titleTabla}>
                        ...
                        <View style={styles.titleTabla__title_2}><Text>{itemGroup.tipo_pago}</Text></View>
                        <View style={styles.titleTabla__title_3}>
                            <View style={styles.titleTabla__title_3__item_1}><Text>{itemGroup.mes === "January" ? (
                                "ENERO"
                            ) : itemGroup.mes === "February" ? (
                                "FEBRERO"
                            ) : itemGroup.mes === "March" ? (
                                "MARZO"
                            ) : itemGroup.mes === "April" ? (
                                ...
                                "JULIO"
                            ) : itemGroup.mes === "August" ? (
                                "AGOSTO"
                            ) : itemGroup.mes === "September" ? (
                                "SEPTIEMBRE"
                            ) : itemGroup.mes === "October" ? (
                                "OCTUBRE"
                            ) : itemGroup.mes === "November" ? (
                                "NOVIEMBRE"
                            ) : itemGroup.mes === "December" && (
                                "DICIEMBRE"
                            )} </Text></View>
                            <View style={styles.titleTabla__title_3__item_2}><Text>{itemGroup.año} </Text></View>
                        </View>
                    </View>
                    <View wrap style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableCol}><Text style={styles.tableHeader}>Ingreso</Text></View>
                        </View>
                        {itemGroup.datos.map((item, itemIndex) => (
                            <View style={styles.tableRow} key={itemIndex}>
                                ...
                                <View style={styles.tableCol}><Text style={styles.tableCell}>{item.fecha_pago}</Text></View>
                                <View style={styles.tableCol}><Text style={styles.tableCell}>{item.ingresos}</Text></View>
                            </View>
                        ))}
