...
const AlumnosBeneficiadosPDF = ({ data }) => {
    return (
        data.length === 0 ? (
            ...
            data.map((itemGroup, groupIndex) => (
                <View wrap style={styles.cuerpo} key={groupIndex}>
                    <View wrap={false} style={styles.titleTabla}>
                        ...
                        <View style={styles.titleTabla__title_2}><Text>{itemGroup.beneficio}</Text></View>
                    ...
                    <View wrap style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableCol}><Text style={styles.tableHeader}>Fecha Nac.</Text></View>
                            <View style={styles.tableCol}><Text style={styles.tableHeader}>Descuento</Text></View>
                        </View>
                        {itemGroup.datos.map((item, itemIndex) => (
                            <View style={styles.tableRow} key={itemIndex}>
                                ...
                                <View style={styles.tableCol}><Text style={styles.tableCell}>{item.fecha_nacimiento}</Text></View>
                                <View style={styles.tableCol}><Text style={styles.tableCell}>{item.descuento}</Text></View>
                            </View>
                        ))}
...
export default AlumnosBeneficiadosPDF