            ...
            data.map((itemGroup, groupIndex) => (
                <View wrap style={styles.cuerpo} key={groupIndex}>
                    <View wrap={false} style={styles.titleTabla}>
                        ...
                        <View style={styles.titleTabla__title_2}><Text>{itemGroup.nombre}</Text></View>
                    ...
                    <View wrap style={styles.table}>
                        <View style={styles.tableRow}>
                            ...
                            <View style={styles.tableCol}><Text style={styles.tableHeader}>Deuda</Text></View>
                        </View>
                        {itemGroup.datos.map((item, itemIndex) => (
                            <View style={styles.tableRow} key={itemIndex}>
                                ...
                                <View style={styles.tableCol}><Text style={styles.tableCell}>{item.deuda}</Text></View>
                            </View>
                        ))}
