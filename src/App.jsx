  ...
  return (
    <div className='bg-blue-claro h-screen'>
      <Routes>
        ...
        <Route element={<ListaUsuarios />} path='/panel-administrador/lista-usuarios' />
        <Route element={<CrearUsuario />} path='/panel-administrador/lista-usuarios/create-user' />
        <Route element={<InformacionUsuario />} path='/panel-administrador/lista-usuarios/info-user/:id' />
        {/* </Route> */}
