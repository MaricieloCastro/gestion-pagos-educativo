...
import "./TableSolicitudEstudiantesDelete.scss";

const TableSolicitudEstudiantesDelete = (props) => {
  ...
  return (
    <div className="bg-white-texto overflow-y-auto h-height-caja-listas mt-4">
      <div className="grid ">
        ...
        {loading ? (
          <table className="solicitud-estudiantes-delete max-w-full">
...
export default TableSolicitudEstudiantesDelete;
